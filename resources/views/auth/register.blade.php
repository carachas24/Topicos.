                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Tu Nombre</label>
                        ...
                        <div class="form-group row{{ $errors->has('lastname') ? ' has-error' : '' }}">
                            <label for="apellido" class="col-md-4 control-label text-md-right">Tu Apellido</label>
                        ...
                        <div class="form-group row{{ $errors->has('telefono') ? ' has-error' : '' }}">
                            <label for="telefono" class="col-md-4 control-label text-md-right">Tu Numero de telefono</label>
